...
function printSelectors(contractName, artifactFolderPath = "../out") {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const factory = new ethers_1.ethers.ContractFactory(contractArtifact.abi, contractArtifact.bytecode);
        const signatures = Object.keys(factory.interface.functions);
        const selectors = signatures.reduce((acc, val) => {
            if (val !== "init(bytes)") {
                acc.push(factory.interface.getSighash(val));
            }
            return acc;
        }, []);
